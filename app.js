...
const app = {
  ...
  loadData() {
    try {
      ...
      if (!this.state.training.rpgBuffs) this.state.training.rpgBuffs = { mobility: null, stability: null, core: null, knees: null, hips: null, cardio: null, recovery: null, warmup: null, plyo: null, posture: null, yoga: null, feet: null };
      // Ajouter les nouveaux types de buffs si absents
      const allBuffTypes = ['mobility','stability','core','knees','hips','cardio','recovery','warmup','plyo','posture','yoga','feet'];
      allBuffTypes.forEach(t => { if (this.state.training.rpgBuffs[t] === undefined) this.state.training.rpgBuffs[t] = null; });
  ...
  getHeroStats() {
    ...
    if (tBuff.warmup?.expiresAt    > now) speedBonus += tBuff.warmup.speedBonus    || 0;
    if (tBuff.plyo?.expiresAt      > now) { atkBonus += tBuff.plyo.atkBonus || 0; speedBonus += tBuff.plyo.speedBonus || 0; }
    if (tBuff.posture?.expiresAt   > now) defBonus   += tBuff.posture.defBonus     || 0;
    if (tBuff.feet?.expiresAt      > now) speedBonus += tBuff.feet.speedBonus      || 0;
  ...
  WORKOUTS: [
    ...
    },
    {
      ...
      exercises: [
        ...
        { name: 'Respiration Diaphragmatique', cue: 'Inspiration 4s, expiration 6s — main sur le ventre', type: 'timed', duration: 60, bilateral: false, svgKey: 'breathing' },
      ]
    },
    {
      id: 'warmup', title: 'Échauffement Pré-Run', emoji: '🏃', duration: '5 min',
      tags: ['Pré-Run', 'Dynamique', 'Quotidien'], type: 'timed', workTime: 30, restTime: 0, rounds: 1,
      xpReward: 30, xpType: 'mobility',
      buff: { type: 'warmup', label: '⚡ +0.1 Vitesse 3h', duration: 10800000, speedBonus: 0.1 },
      exercises: [
        { name: 'Leg Swings Frontaux', cue: 'Amplitude maximale, jambe tendue comme un pendule', type: 'timed', duration: 30, bilateral: true, svgKey: 'leg-swings-front' },
        { name: 'Leg Swings Latéraux', cue: 'Tenu au mur, balance la jambe de côté', type: 'timed', duration: 30, bilateral: true, svgKey: 'leg-swings-lateral' },
        { name: 'Hip Circles Debout', cue: 'Grands cercles de hanche, buste immobile', type: 'timed', duration: 30, bilateral: true, svgKey: 'hip-circles-standing' },
        { name: 'Fentes Marchées', cue: 'Genou avant ne dépasse pas les orteils, pas en avant', type: 'timed', duration: 30, bilateral: false, svgKey: 'walking-lunges' },
        { name: 'Talons-Fesses', cue: 'Course sur place, talon touche les fessiers', type: 'timed', duration: 30, bilateral: false, svgKey: 'butt-kicks' },
        { name: 'Montées de Genoux Lentes', cue: 'Genou à hauteur de hanche, bras opposé', type: 'timed', duration: 30, bilateral: false, svgKey: 'high-knees' },
      ]
    },
    {
      id: 'plyo', title: 'Plyométrie Trail', emoji: '💥', duration: '15 min',
      tags: ['Puissance', 'Trail', 'Réactif'], type: 'circuit', workTime: 30, restTime: 15, rounds: 4,
      xpReward: 160, xpType: 'cardio',
      buff: { type: 'plyo', label: '💥 +8 ATK +0.1 Vitesse 24h', duration: 86400000, atkBonus: 8, speedBonus: 0.1 },
      exercises: [
        { name: 'Drop Jump', cue: 'Atterrissage ultra-souple, genoux fléchis, silence', type: 'timed', duration: 30, bilateral: false, svgKey: 'drop-jump' },
        { name: 'Single-Leg Landing', cue: 'Saute, atterris sur une jambe — stabilise 2s', type: 'timed', duration: 30, bilateral: false, svgKey: 'single-leg-landing' },
        { name: 'Skipping Qualitatif', cue: 'Genou haut, poussée du sol explosive, bras actifs', type: 'timed', duration: 30, bilateral: false, svgKey: 'skipping' },
        { name: 'Side Hops avec Stabilisation', cue: 'Saute latéral, stabilise 1s à l\'atterrissage', type: 'timed', duration: 30, bilateral: false, svgKey: 'lateral-bound' },
        { name: 'Broad Jump', cue: 'Saut horizontal maximal, atterrissage amorti et stable', type: 'timed', duration: 30, bilateral: false, svgKey: 'broad-jump' },
      ]
    },
    {
      id: 'posture', title: 'Posture & Haut du Corps', emoji: '🦅', duration: '15 min',
      tags: ['Posture', 'Dos', 'Bâtons'], type: 'reps', restBetweenSets: 60,
      xpReward: 110, xpType: 'strength',
      buff: { type: 'posture', label: '🛡️ +3 DEF 24h', duration: 86400000, defBonus: 3 },
      exercises: [
        { name: 'Face Pull au Sol', cue: 'Tire les coudes vers le plafond, omoplate se rapprochent', type: 'reps', sets: 3, reps: '15', bilateral: false, restBetweenSets: 60, svgKey: 'face-pull-prone' },
        { name: 'YTW Prone', cue: 'Enchaîne Y (bras à 45°), T (à 90°), W (coudes fléchis)', type: 'reps', sets: 3, reps: '10', bilateral: false, restBetweenSets: 60, svgKey: 'ytw-prone' },
        { name: 'Push-Up Excentrique', cue: 'Descends en 4 secondes, remonte normalement', type: 'reps', sets: 3, reps: '8', bilateral: false, restBetweenSets: 60, svgKey: 'push-up-eccentric' },
        { name: 'Reverse Snow Angels', cue: 'Prone, bras glissent des hanches au-dessus de la tête', type: 'reps', sets: 3, reps: '12', bilateral: false, restBetweenSets: 60, svgKey: 'reverse-snow-angels' },
        { name: 'Rétraction des Omoplates', cue: 'Serre les omoplates 3s, relâche lentement', type: 'reps', sets: 3, reps: '15', bilateral: false, restBetweenSets: 60, svgKey: 'scapular-retraction' },
      ]
    },
    {
      id: 'yoga', title: 'Yoga Flow Trail', emoji: '🌿', duration: '20 min',
      tags: ['Yoga', 'Mobilité', 'Post-Run'], type: 'timed', workTime: 60, restTime: 0, rounds: 1,
      xpReward: 90, xpType: 'recovery',
      buff: { type: 'yoga', label: '🌿 Soigne 10 HP + retire debuffs', duration: 0, healHp: 10, clearsDebuffs: true },
      exercises: [
        { name: 'Pigeon Pose Flow', cue: 'Relâche progressivement, respiration profonde', type: 'stretch', duration: 60, sets: 1, bilateral: true, svgKey: 'pigeon-pose' },
        { name: 'Lizard Pose', cue: 'Fente basse, main intérieure au sol, hanche basse', type: 'stretch', duration: 60, sets: 1, bilateral: true, svgKey: 'lizard-pose' },
        { name: 'Thoracic Rotation Flow', cue: 'Rotation lente, cherche l\'amplitude en expirant', type: 'timed', duration: 60, bilateral: true, svgKey: 'thoracic-rotation' },
        { name: 'Downward Dog', cue: 'Hanches hautes, talons qui cherchent le sol, jambes tendues', type: 'timed', duration: 60, bilateral: false, svgKey: 'downward-dog' },
        { name: 'Hip Opener 90/90', cue: 'Les deux genoux à 90°, buste en avant sur la jambe avant', type: 'stretch', duration: 60, sets: 1, bilateral: true, svgKey: 'hip-9090' },
        { name: 'Twisted Crescent', cue: 'Fente haute, rotation thoracique, bras vers le plafond', type: 'stretch', duration: 60, sets: 1, bilateral: true, svgKey: 'twisted-crescent' },
        { name: 'Savasana', cue: 'Allongé, corps totalement relâché, respiration libre', type: 'timed', duration: 120, bilateral: false, svgKey: 'savasana' },
      ]
    },
    {
      id: 'feet', title: 'Renforcement Pieds & Chevilles', emoji: '🦶', duration: '10 min',
      tags: ['Pieds', 'Chevilles', 'Trail'], type: 'reps', restBetweenSets: 45,
      xpReward: 80, xpType: 'stability',
      buff: { type: 'feet', label: '⚡ +0.2 Vitesse 24h', duration: 86400000, speedBonus: 0.2 },
      exercises: [
        { name: 'Toe Spreads', cue: 'Écarte les orteils au maximum, maintiens 2s', type: 'reps', sets: 3, reps: '10', bilateral: false, restBetweenSets: 30, svgKey: 'toe-spreads' },
        { name: 'Short Foot (Voûte Plantaire)', cue: 'Raccourcis le pied sans recroqueviller les orteils', type: 'reps', sets: 3, reps: '12', bilateral: true, restBetweenSets: 30, svgKey: 'foot-doming' },
        { name: 'Isométrique Cheville', cue: 'Presse le pied contre le sol — tiens la contraction', type: 'timed', duration: 30, sets: 3, bilateral: true, restBetweenSets: 30, svgKey: 'ankle-iso' },
        { name: 'Marche Talon-Pointe', cue: 'Pose le talon, déroule jusqu\'à la pointe, contrôlé', type: 'reps', sets: 3, reps: '20', bilateral: false, restBetweenSets: 30, svgKey: 'heel-toe-walk' },
        { name: 'Équilibre sur Surface Instable', cue: 'Serviette pliée sous le pied, reste stable 30s', type: 'timed', duration: 30, sets: 3, bilateral: true, restBetweenSets: 30, svgKey: 'balance-unstable' },
      ]
    },
  ],
  ...
  WORKOUT_SVG: {
    ...
    // ── Échauffement Pré-Run ──
    'leg-swings-front': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="38" cy="12" r="6" fill="#94a3b8" stroke="none"/><line x1="38" y1="18" x2="38" y2="44" stroke-width="2.5"/><line x1="38" y1="26" x2="26" y2="38" stroke-width="2"/><line x1="38" y1="26" x2="50" y2="38" stroke-width="2"/><line x1="38" y1="44" x2="30" y2="65" stroke-width="2.5"/><line x1="38" y1="44" x2="46" y2="65" stroke-width="2.5"/></g><line x1="78" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="158" cy="12" r="6" fill="#94a3b8" stroke="none"/><line x1="158" y1="18" x2="158" y2="44" stroke-width="2.5"/><line x1="158" y1="26" x2="146" y2="36" stroke-width="2"/><line x1="158" y1="26" x2="170" y2="36" stroke-width="2"/><line x1="158" y1="44" x2="150" y2="65" stroke-width="2.5"/></g><line x1="158" y1="44" x2="178" y2="22" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/></svg>`,

    'leg-swings-lateral': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="30" y="10" width="4" height="58" rx="2" fill="rgba(148,163,184,0.2)" stroke="#64748b" stroke-width="1"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="42" cy="13" r="6" fill="#94a3b8" stroke="none"/><line x1="42" y1="19" x2="42" y2="44" stroke-width="2.5"/><line x1="42" y1="27" x2="34" y2="36" stroke-width="2"/><line x1="42" y1="44" x2="35" y2="65" stroke-width="2.5"/><line x1="42" y1="44" x2="48" y2="65" stroke-width="2.5"/></g><line x1="78" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><rect x="140" y="10" width="4" height="58" rx="2" fill="rgba(148,163,184,0.2)" stroke="#64748b" stroke-width="1"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="152" cy="13" r="6" fill="#94a3b8" stroke="none"/><line x1="152" y1="19" x2="152" y2="44" stroke-width="2.5"/><line x1="152" y1="27" x2="144" y2="36" stroke-width="2"/><line x1="152" y1="44" x2="145" y2="65" stroke-width="2.5"/></g><line x1="152" y1="44" x2="176" y2="38" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/></svg>`,

    'hip-circles-standing': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="38" cy="12" r="6" fill="#94a3b8" stroke="none"/><line x1="38" y1="18" x2="38" y2="44" stroke-width="2.5"/><line x1="38" y1="26" x2="26" y2="38" stroke-width="2"/><line x1="38" y1="26" x2="50" y2="38" stroke-width="2"/><line x1="38" y1="44" x2="30" y2="65" stroke-width="2.5"/><line x1="38" y1="44" x2="46" y2="65" stroke-width="2.5"/></g><line x1="78" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="158" cy="12" r="6" fill="#94a3b8" stroke="none"/><line x1="158" y1="18" x2="158" y2="44" stroke-width="2.5"/><line x1="158" y1="26" x2="146" y2="38" stroke-width="2"/><line x1="158" y1="26" x2="170" y2="38" stroke-width="2"/><line x1="158" y1="44" x2="150" y2="65" stroke-width="2.5"/><line x1="158" y1="44" x2="166" y2="65" stroke-width="2.5"/></g><ellipse cx="158" cy="42" rx="12" ry="6" stroke="#60a5fa" stroke-width="1.5" stroke-dasharray="3 2"/></svg>`,

    'walking-lunges': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="35" cy="14" r="6" fill="#94a3b8" stroke="none"/><line x1="35" y1="20" x2="35" y2="42" stroke-width="2.5"/><line x1="35" y1="28" x2="23" y2="38" stroke-width="2"/><line x1="35" y1="28" x2="47" y2="38" stroke-width="2"/><line x1="35" y1="42" x2="28" y2="65" stroke-width="2.5"/><line x1="35" y1="42" x2="42" y2="65" stroke-width="2.5"/></g><line x1="76" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="155" cy="12" r="6" fill="#94a3b8" stroke="none"/><line x1="155" y1="18" x2="155" y2="40" stroke-width="2.5"/><line x1="155" y1="26" x2="143" y2="36" stroke-width="2"/><line x1="155" y1="26" x2="167" y2="36" stroke-width="2"/><line x1="155" y1="40" x2="170" y2="62" stroke-width="2.5"/><line x1="155" y1="40" x2="138" y2="55" stroke-width="2.5"/><line x1="138" y1="55" x2="132" y2="68" stroke-width="2.5"/></g></svg>`,

    'butt-kicks': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="35" cy="12" r="6" fill="#94a3b8" stroke="none"/><line x1="35" y1="18" x2="35" y2="40" stroke-width="2.5"/><line x1="35" y1="26" x2="23" y2="36" stroke-width="2"/><line x1="35" y1="26" x2="47" y2="36" stroke-width="2"/><line x1="35" y1="40" x2="28" y2="62" stroke-width="2.5"/><line x1="35" y1="40" x2="42" y2="62" stroke-width="2.5"/></g><line x1="78" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="158" cy="12" r="6" fill="#94a3b8" stroke="none"/><line x1="158" y1="18" x2="158" y2="40" stroke-width="2.5"/><line x1="158" y1="26" x2="146" y2="34" stroke-width="2"/><line x1="158" y1="26" x2="170" y2="34" stroke-width="2"/><line x1="158" y1="40" x2="150" y2="62" stroke-width="2.5"/><line x1="158" y1="40" x2="165" y2="52" stroke-width="2.5"/></g><line x1="165" y1="52" x2="158" y2="38" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/></svg>`,

    // ── Plyométrie Trail ──
    'drop-jump': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="42" width="28" height="12" rx="2" fill="rgba(96,165,250,0.1)" stroke="#64748b" stroke-width="1"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="25" cy="14" r="6" fill="#94a3b8" stroke="none"/><line x1="25" y1="20" x2="25" y2="42" stroke-width="2.5"/><line x1="25" y1="28" x2="13" y2="38" stroke-width="2"/><line x1="25" y1="28" x2="37" y2="38" stroke-width="2"/><line x1="25" y1="42" x2="18" y2="54" stroke-width="2.5"/><line x1="25" y1="42" x2="32" y2="54" stroke-width="2.5"/></g><line x1="60" y1="42" x2="100" y2="42" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,38 108,42 98,46" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="155" cy="22" r="6" fill="#94a3b8" stroke="none"/><line x1="155" y1="28" x2="155" y2="48" stroke-width="2.5"/><line x1="155" y1="36" x2="143" y2="44" stroke-width="2"/><line x1="155" y1="36" x2="167" y2="44" stroke-width="2"/><line x1="155" y1="48" x2="146" y2="65" stroke-width="2.5"/><line x1="155" y1="48" x2="162" y2="60" stroke-width="2.5"/></g><line x1="146" y1="65" x2="180" y2="65" stroke="#94a3b8" stroke-width="2" stroke-linecap="round"/></svg>`,

    'single-leg-landing': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="35" cy="10" r="6" fill="#94a3b8" stroke="none"/><line x1="35" y1="16" x2="38" y2="38" stroke-width="2.5"/><line x1="36" y1="24" x2="24" y2="32" stroke-width="2"/><line x1="36" y1="24" x2="48" y2="30" stroke-width="2"/><line x1="38" y1="38" x2="30" y2="58" stroke-width="2.5"/><line x1="38" y1="38" x2="46" y2="55" stroke-width="2.5"/></g><line x1="78" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="158" cy="14" r="6" fill="#94a3b8" stroke="none"/><line x1="158" y1="20" x2="158" y2="46" stroke-width="2.5"/><line x1="158" y1="30" x2="146" y2="40" stroke-width="2"/><line x1="158" y1="30" x2="170" y2="40" stroke-width="2"/><line x1="158" y1="46" x2="150" y2="66" stroke-width="2.5"/></g><line x1="158" y1="46" x2="166" y2="32" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/><line x1="166" y1="32" x2="170" y2="46" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/><line x1="148" y1="66" x2="162" y2="66" stroke="#94a3b8" stroke-width="2" stroke-linecap="round"/></svg>`,

    'skipping': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="35" cy="10" r="6" fill="#94a3b8" stroke="none"/><line x1="35" y1="16" x2="35" y2="38" stroke-width="2.5"/><line x1="35" y1="24" x2="22" y2="32" stroke-width="2"/><line x1="35" y1="24" x2="48" y2="32" stroke-width="2"/><line x1="35" y1="38" x2="28" y2="60" stroke-width="2.5"/><line x1="35" y1="38" x2="42" y2="50" stroke-width="2.5"/><line x1="42" y1="50" x2="50" y2="62" stroke-width="2.5"/></g><line x1="78" y1="38" x2="100" y2="38" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,34 108,38 98,42" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="158" cy="8" r="6" fill="#94a3b8" stroke="none"/><line x1="158" y1="14" x2="158" y2="36" stroke-width="2.5"/><line x1="158" y1="22" x2="145" y2="30" stroke-width="2"/><line x1="158" y1="22" x2="171" y2="30" stroke-width="2"/><line x1="158" y1="36" x2="166" y2="55" stroke-width="2.5"/><line x1="158" y1="36" x2="148" y2="25" stroke-width="2.5"/></g><line x1="148" y1="25" x2="140" y2="38" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/></svg>`,

    'broad-jump': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="25" cy="18" r="6" fill="#94a3b8" stroke="none"/><line x1="25" y1="24" x2="25" y2="46" stroke-width="2.5"/><line x1="25" y1="32" x2="13" y2="42" stroke-width="2"/><line x1="25" y1="32" x2="37" y2="42" stroke-width="2"/><line x1="25" y1="46" x2="17" y2="62" stroke-width="2.5"/><line x1="25" y1="46" x2="33" y2="58" stroke-width="2.5"/></g><line x1="55" y1="40" x2="110" y2="40" stroke="#60a5fa" stroke-width="2"/><polygon points="108,36 118,40 108,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="168" cy="14" r="6" fill="#94a3b8" stroke="none"/><line x1="168" y1="20" x2="168" y2="42" stroke-width="2.5"/><line x1="168" y1="28" x2="156" y2="36" stroke-width="2"/><line x1="168" y1="28" x2="180" y2="36" stroke-width="2"/><line x1="168" y1="42" x2="160" y2="60" stroke-width="2.5"/><line x1="168" y1="42" x2="176" y2="60" stroke-width="2.5"/></g></svg>`,

    // ── Posture & Haut du Corps ──
    'face-pull-prone': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="12" cy="40" r="5" fill="#94a3b8" stroke="none"/><line x1="17" y1="40" x2="62" y2="40" stroke-width="2.5"/><line x1="30" y1="40" x2="22" y2="32" stroke-width="2"/><line x1="30" y1="40" x2="22" y2="48" stroke-width="2"/><line x1="55" y1="40" x2="48" y2="50" stroke-width="2.5"/><line x1="55" y1="40" x2="62" y2="50" stroke-width="2.5"/></g><line x1="78" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="122" cy="40" r="5" fill="#94a3b8" stroke="none"/><line x1="127" y1="40" x2="172" y2="40" stroke-width="2.5"/><line x1="165" y1="40" x2="158" y2="50" stroke-width="2.5"/><line x1="165" y1="40" x2="172" y2="50" stroke-width="2.5"/></g><line x1="140" y1="40" x2="128" y2="26" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/><line x1="140" y1="40" x2="128" y2="54" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/></svg>`,

    'ytw-prone': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="12" cy="40" r="5" fill="#94a3b8" stroke="none"/><line x1="17" y1="40" x2="62" y2="40" stroke-width="2.5"/><line x1="32" y1="40" x2="24" y2="50" stroke-width="2.5"/><line x1="32" y1="40" x2="24" y2="30" stroke-width="2.5"/><line x1="52" y1="40" x2="44" y2="50" stroke-width="2.5"/><line x1="52" y1="40" x2="44" y2="30" stroke-width="2.5"/></g><line x1="78" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="122" cy="40" r="5" fill="#94a3b8" stroke="none"/><line x1="127" y1="40" x2="172" y2="40" stroke-width="2.5"/><line x1="165" y1="40" x2="158" y2="50" stroke-width="2.5"/><line x1="165" y1="40" x2="172" y2="50" stroke-width="2.5"/></g><line x1="140" y1="40" x2="124" y2="22" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/><line x1="140" y1="40" x2="124" y2="58" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/></svg>`,

    'push-up-eccentric': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="14" cy="22" r="5" fill="#94a3b8" stroke="none"/><line x1="18" y1="24" x2="58" y2="34" stroke-width="2.5"/><line x1="22" y1="26" x2="17" y2="44" stroke-width="2.5"/><line x1="22" y1="26" x2="30" y2="44" stroke-width="2.5"/><line x1="58" y1="34" x2="52" y2="52" stroke-width="2.5"/><line x1="58" y1="34" x2="65" y2="52" stroke-width="2.5"/></g><line x1="78" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="124" cy="34" r="5" fill="#94a3b8" stroke="none"/><line x1="128" y1="36" x2="168" y2="44" stroke-width="2.5"/><line x1="132" y1="37" x2="127" y2="55" stroke-width="2.5"/><line x1="132" y1="37" x2="140" y2="55" stroke-width="2.5"/><line x1="168" y1="44" x2="162" y2="60" stroke-width="2.5"/><line x1="168" y1="44" x2="175" y2="60" stroke-width="2.5"/></g><text x="150" y="28" text-anchor="middle" fill="#60a5fa" font-size="9" font-family="sans-serif">4s ↓</text></svg>`,

    'reverse-snow-angels': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="12" cy="40" r="5" fill="#94a3b8" stroke="none"/><line x1="17" y1="40" x2="65" y2="40" stroke-width="2.5"/><line x1="32" y1="40" x2="26" y2="50" stroke-width="2"/><line x1="32" y1="40" x2="38" y2="50" stroke-width="2"/><line x1="55" y1="40" x2="48" y2="50" stroke-width="2.5"/><line x1="55" y1="40" x2="62" y2="50" stroke-width="2.5"/></g><line x1="78" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="122" cy="40" r="5" fill="#94a3b8" stroke="none"/><line x1="127" y1="40" x2="175" y2="40" stroke-width="2.5"/><line x1="162" y1="40" x2="155" y2="50" stroke-width="2.5"/><line x1="162" y1="40" x2="169" y2="50" stroke-width="2.5"/></g><line x1="142" y1="40" x2="120" y2="25" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/><line x1="142" y1="40" x2="162" y2="25" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/></svg>`,

    'scapular-retraction': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="38" cy="12" r="6" fill="#94a3b8" stroke="none"/><line x1="38" y1="18" x2="38" y2="44" stroke-width="2.5"/><line x1="38" y1="26" x2="24" y2="36" stroke-width="2"/><line x1="38" y1="26" x2="52" y2="36" stroke-width="2"/><line x1="38" y1="44" x2="30" y2="65" stroke-width="2.5"/><line x1="38" y1="44" x2="46" y2="65" stroke-width="2.5"/></g><line x1="78" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="158" cy="12" r="6" fill="#94a3b8" stroke="none"/><line x1="158" y1="18" x2="158" y2="44" stroke-width="2.5"/><line x1="158" y1="44" x2="150" y2="65" stroke-width="2.5"/><line x1="158" y1="44" x2="166" y2="65" stroke-width="2.5"/></g><line x1="158" y1="26" x2="140" y2="38" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/><line x1="158" y1="26" x2="176" y2="38" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/><line x1="140" y1="38" x2="148" y2="38" stroke="#60a5fa" stroke-width="1.5" stroke-linecap="round"/><line x1="176" y1="38" x2="168" y2="38" stroke="#60a5fa" stroke-width="1.5" stroke-linecap="round"/></svg>`,

    // ── Yoga Flow Trail ──
    'lizard-pose': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="35" cy="14" r="6" fill="#94a3b8" stroke="none"/><line x1="35" y1="20" x2="35" y2="42" stroke-width="2.5"/><line x1="35" y1="28" x2="23" y2="38" stroke-width="2"/><line x1="35" y1="28" x2="47" y2="38" stroke-width="2"/><line x1="35" y1="42" x2="20" y2="65" stroke-width="2.5"/><line x1="35" y1="42" x2="50" y2="55" stroke-width="2.5"/><line x1="50" y1="55" x2="55" y2="70" stroke-width="2"/></g><line x1="76" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="148" cy="22" r="6" fill="#94a3b8" stroke="none"/><line x1="148" y1="28" x2="152" y2="46" stroke-width="2.5"/><line x1="150" y1="36" x2="132" y2="48" stroke-width="2"/><line x1="150" y1="36" x2="164" y2="44" stroke-width="2"/><line x1="152" y1="46" x2="128" y2="55" stroke-width="2.5"/><line x1="128" y1="55" x2="118" y2="68" stroke-width="2.5"/><line x1="152" y1="46" x2="172" y2="60" stroke-width="2.5"/><line x1="172" y1="60" x2="178" y2="70" stroke-width="2"/></g><line x1="132" y1="48" x2="116" y2="48" stroke="#60a5fa" stroke-width="1.5" stroke-dasharray="3 2"/></svg>`,

    'downward-dog': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="38" cy="14" r="6" fill="#94a3b8" stroke="none"/><line x1="38" y1="20" x2="38" y2="44" stroke-width="2.5"/><line x1="38" y1="28" x2="26" y2="38" stroke-width="2"/><line x1="38" y1="28" x2="50" y2="38" stroke-width="2"/><line x1="38" y1="44" x2="30" y2="65" stroke-width="2.5"/><line x1="38" y1="44" x2="46" y2="65" stroke-width="2.5"/></g><line x1="76" y1="38" x2="100" y2="38" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,34 108,38 98,42" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="158" cy="25" r="6" fill="#94a3b8" stroke="none"/><line x1="154" y1="30" x2="138" y2="50" stroke-width="2.5"/><line x1="162" y1="30" x2="178" y2="50" stroke-width="2.5"/><line x1="138" y1="50" x2="128" y2="65" stroke-width="2.5"/><line x1="178" y1="50" x2="188" y2="65" stroke-width="2.5"/><line x1="138" y1="50" x2="178" y2="50" stroke-width="3"/></g></svg>`,

    'twisted-crescent': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="35" cy="14" r="6" fill="#94a3b8" stroke="none"/><line x1="35" y1="20" x2="35" y2="42" stroke-width="2.5"/><line x1="35" y1="28" x2="23" y2="38" stroke-width="2"/><line x1="35" y1="28" x2="47" y2="38" stroke-width="2"/><line x1="35" y1="42" x2="20" y2="65" stroke-width="2.5"/><line x1="35" y1="42" x2="50" y2="55" stroke-width="2.5"/><line x1="50" y1="55" x2="55" y2="68" stroke-width="2"/></g><line x1="76" y1="38" x2="100" y2="38" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,34 108,38 98,42" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="152" cy="18" r="6" fill="#94a3b8" stroke="none"/><line x1="152" y1="24" x2="152" y2="42" stroke-width="2.5"/><line x1="152" y1="32" x2="140" y2="40" stroke-width="2"/><line x1="152" y1="42" x2="136" y2="65" stroke-width="2.5"/><line x1="152" y1="42" x2="165" y2="55" stroke-width="2.5"/><line x1="165" y1="55" x2="170" y2="68" stroke-width="2"/></g><line x1="152" y1="32" x2="168" y2="14" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/></svg>`,

    'savasana': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round" opacity="0.7"><circle cx="12" cy="38" r="5" fill="#94a3b8" stroke="none"/><line x1="17" y1="38" x2="70" y2="40" stroke-width="3"/><line x1="35" y1="39" x2="28" y2="55" stroke-width="2"/><line x1="35" y1="39" x2="28" y2="25" stroke-width="2"/><line x1="58" y1="40" x2="50" y2="55" stroke-width="2.5"/><line x1="58" y1="40" x2="50" y2="25" stroke-width="2.5"/></g><line x1="78" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round" opacity="0.45"><circle cx="122" cy="38" r="5" fill="#94a3b8" stroke="none"/><line x1="127" y1="38" x2="180" y2="40" stroke-width="3"/><line x1="145" y1="39" x2="138" y2="56" stroke-width="2"/><line x1="145" y1="39" x2="138" y2="24" stroke-width="2"/><line x1="168" y1="40" x2="160" y2="56" stroke-width="2.5"/><line x1="168" y1="40" x2="160" y2="24" stroke-width="2.5"/></g><text x="155" y="22" text-anchor="middle" fill="#60a5fa" font-size="9" font-family="sans-serif">relâche…</text></svg>`,

    // ── Renforcement Pieds & Chevilles ──
    'toe-spreads': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><line x1="20" y1="45" x2="70" y2="45" stroke-width="4"/><line x1="25" y1="45" x2="22" y2="30" stroke-width="2.5"/><line x1="35" y1="45" x2="33" y2="28" stroke-width="2.5"/><line x1="45" y1="45" x2="44" y2="27" stroke-width="2.5"/><line x1="55" y1="45" x2="55" y2="28" stroke-width="2.5"/><line x1="65" y1="45" x2="67" y2="30" stroke-width="2.5"/></g><line x1="78" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><line x1="130" y1="45" x2="180" y2="45" stroke-width="4"/></g><line x1="133" y1="45" x2="122" y2="25" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/><line x1="142" y1="45" x2="138" y2="22" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/><line x1="155" y1="45" x2="155" y2="22" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/><line x1="168" y1="45" x2="172" y2="22" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/><line x1="177" y1="45" x2="188" y2="25" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/></svg>`,

    'foot-doming': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><line x1="15" y1="55" x2="72" y2="55" stroke-width="3"/><line x1="15" y1="55" x2="12" y2="42" stroke-width="2"/><path d="M15 55 Q44 55 72 55" stroke-width="2" fill="none"/><line x1="72" y1="55" x2="75" y2="42" stroke-width="2"/><line x1="25" y1="55" x2="22" y2="44" stroke-width="2"/><line x1="40" y1="55" x2="38" y2="43" stroke-width="2"/><line x1="55" y1="55" x2="54" y2="43" stroke-width="2"/><line x1="65" y1="55" x2="65" y2="44" stroke-width="2"/></g><line x1="78" y1="45" x2="100" y2="45" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,41 108,45 98,49" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><line x1="125" y1="55" x2="182" y2="55" stroke-width="3"/><line x1="125" y1="55" x2="122" y2="42" stroke-width="2"/><path d="M125 55 Q138 42 154 55" stroke="#60a5fa" stroke-width="2" fill="none"/><line x1="182" y1="55" x2="185" y2="42" stroke-width="2"/><line x1="135" y1="55" x2="132" y2="44" stroke-width="2"/><line x1="165" y1="55" x2="164" y2="43" stroke-width="2"/><line x1="175" y1="55" x2="175" y2="44" stroke-width="2"/></g></svg>`,

    'ankle-iso': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="38" cy="12" r="6" fill="#94a3b8" stroke="none"/><line x1="38" y1="18" x2="38" y2="44" stroke-width="2.5"/><line x1="38" y1="26" x2="26" y2="38" stroke-width="2"/><line x1="38" y1="26" x2="50" y2="38" stroke-width="2"/><line x1="38" y1="44" x2="30" y2="65" stroke-width="2.5"/><line x1="38" y1="44" x2="46" y2="65" stroke-width="2.5"/></g><line x1="78" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="158" cy="12" r="6" fill="#94a3b8" stroke="none"/><line x1="158" y1="18" x2="158" y2="44" stroke-width="2.5"/><line x1="158" y1="26" x2="146" y2="38" stroke-width="2"/><line x1="158" y1="26" x2="170" y2="38" stroke-width="2"/><line x1="158" y1="44" x2="150" y2="65" stroke-width="2.5"/><line x1="158" y1="44" x2="166" y2="65" stroke-width="2.5"/></g><line x1="148" y1="65" x2="168" y2="65" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/><line x1="158" y1="60" x2="158" y2="68" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/></svg>`,

    'heel-toe-walk': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="#94a3b8" stroke-linecap="round"><circle cx="30" cy="14" r="6" fill="#94a3b8" stroke="none"/><line x1="30" y1="20" x2="30" y2="44" stroke-width="2.5"/><line x1="30" y1="28" x2="18" y2="38" stroke-width="2"/><line x1="30" y1="28" x2="42" y2="38" stroke-width="2"/><line x1="30" y1="44" x2="20" y2="65" stroke-width="2.5"/><line x1="30" y1="44" x2="38" y2="62" stroke-width="2.5"/><line x1="20" y1="65" x2="16" y2="65" stroke-width="2"/></g><circle cx="16" cy="64" r="3" fill="#60a5fa"/><line x1="68" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="162" cy="14" r="6" fill="#94a3b8" stroke="none"/><line x1="162" y1="20" x2="162" y2="44" stroke-width="2.5"/><line x1="162" y1="28" x2="150" y2="38" stroke-width="2"/><line x1="162" y1="28" x2="174" y2="38" stroke-width="2"/><line x1="162" y1="44" x2="152" y2="65" stroke-width="2.5"/><line x1="162" y1="44" x2="170" y2="62" stroke-width="2.5"/><line x1="170" y1="62" x2="182" y2="62" stroke-width="2"/></g><circle cx="182" cy="61" r="3" fill="#60a5fa"/></svg>`,

    'balance-unstable': `<svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse cx="38" cy="66" rx="16" ry="5" fill="rgba(96,165,250,0.15)" stroke="#60a5fa" stroke-width="1"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="38" cy="12" r="6" fill="#94a3b8" stroke="none"/><line x1="38" y1="18" x2="38" y2="44" stroke-width="2.5"/><line x1="38" y1="26" x2="26" y2="38" stroke-width="2"/><line x1="38" y1="26" x2="50" y2="38" stroke-width="2"/><line x1="38" y1="44" x2="30" y2="62" stroke-width="2.5"/><line x1="38" y1="44" x2="46" y2="62" stroke-width="2.5"/></g><line x1="78" y1="40" x2="100" y2="40" stroke="#60a5fa" stroke-width="1.5"/><polygon points="98,36 108,40 98,44" fill="#60a5fa"/><ellipse cx="158" cy="66" rx="16" ry="5" fill="rgba(96,165,250,0.15)" stroke="#60a5fa" stroke-width="1"/><g stroke="#94a3b8" stroke-linecap="round"><circle cx="158" cy="12" r="6" fill="#94a3b8" stroke="none"/><line x1="158" y1="18" x2="158" y2="44" stroke-width="2.5"/><line x1="158" y1="26" x2="146" y2="38" stroke-width="2"/><line x1="158" y1="26" x2="170" y2="38" stroke-width="2"/><line x1="158" y1="44" x2="152" y2="62" stroke-width="2.5"/></g><line x1="158" y1="44" x2="164" y2="30" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/><line x1="164" y1="30" x2="166" y2="44" stroke="#60a5fa" stroke-width="2.5" stroke-linecap="round"/></svg>`,
  },
  ...
  completeWorkout(workoutId, durationSec, mode = 'full', feeling = 'ok') {
    ...
    if (b.type === 'recovery' || b.type === 'yoga') {
